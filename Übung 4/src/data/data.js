export const exercises = [
    ...
    subtasks: [
      {
        ...
        content: [
          ...
          },
          {
            id: 3,
            type: "git-clone",
            content: "https://gitlab.hsrw.eu/lv-mkg/exercises/app-mkg.git",
          },
          {
            id: 4,
            type: "text",
          ...
          { id: 7, type: "code", content: "install npm" },
          {
            ...
            type: "text",
            content:
              "Next please, start the development build to see the exercises typing",
          },
  ...
  },
  {
    ...
    subtasks: [
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            type: "code",
            content:
              "Buch: Schrifttypen – Verstehen Kombinieren: Schriftmischung als Reiz in der Typografie, Philipp Stamm, Berlin, Boston: Birkhäuser, 2020. https://doi-org.ezproxy2.hsrw.eu/10.1515/9783035609011",
          },
          {
            id: 2,
            type: "text",
      ...
      },
      {
        id: 3, //use in JSX as key
        title:
          "Adobe Illustrator (or alternatives) - Infinity sign* (Deadline: 5th June)",
        done: false, // flag: did I solve it already?
        content: [
          {
            id: 0,
          ...
          { id: 1, type: "img", content: "../assets/infinity.png", alt: "" },
          {
            id: 2,
            type: "text",
            content: "Please submit the vector-file.",
          },
        ],
      },
    ],
  },
  {
    ...
    subtitle: "Deadline 21th May (with support in PC-Pool~1)",
    source: {
      name: "X",
      source: "https",
    },
        ...
        content: [
          {
            ...
            type: "text",
            content:
              'Workout a "first" Design-Version of your project and take care of:',
          },
          {
            id: 1,
            type: "list",
        ...
        content: [
          {
            ...
            type: "text",
            content:
              "How to import an Adobe Xd Prototype into Figma? Create a simple example of a design including prototyping in Adobe Xd and transfer it to Figma incl. all your prototype links. You can demonstrate this in the exercises to get the (*).",
          },
        ],
      },
    ],
    ...
    subtasks: [
      {
        ...
        content: [
          ...
          },
          {
            id: 3,
            type: "text",
            content: "At the beginning, work with",
          },
          {
            id: 4,
            type: "code",
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            type: "text",
            content:
              "For the subtasks, your formular needs to differentiate between the following content-types:",
          },
          {
            id: 9,
            type: "list",
          ...
          },
          {
            ...
            type: "text",
            content:
              "Recommended: First, you should create the requirements (user stories) for the Add New Exercise page. Then develope a prototype (user guidance and layout). After these steps you should start developing the site including its functionalities.",
          },
        ],
      },
      {
        id: 2, //use in JSX as key
        title: "Mock Data, API Mocking*",
        done: false, // flag: did I solve it already?
        content: [
          {
            id: 0,
          ...
          },
          {
            ...
            type: "list",
            content: [
              "Create a server which simulates some API (usually a placeholder for backend database)",
      ...
      {
        id: 4, //use in JSX as key
        title: "Restyle your ExerciseApp*",
        done: false, // flag: did I solve it already?
        content: [
          {
            id: 0,
